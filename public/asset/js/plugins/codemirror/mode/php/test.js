...
(function() {
  ...
  MT('variable_interpolation_simple_syntax_2',
     '[meta <?php]',
     '[keyword echo] [string "][variable-2 $aaaa][[','[number 2]',         ']][string mddatapribadipegawai"];',
     '[keyword echo] [string "][variable-2 $aaaa][[','[number 2345]',      ']][string mddatapribadipegawai"];',
     '[keyword echo] [string "][variable-2 $aaaa][[','[number 2.3]',       ']][string mddatapribadipegawai"];',
     '[keyword echo] [string "][variable-2 $aaaa][[','[variable aaaaa]',   ']][string mddatapribadipegawai"];',
     '[keyword echo] [string "][variable-2 $aaaa][[','[variable-2 $aaaaa]',']][string mddatapribadipegawai"];',

     '[keyword echo] [string "1aaa][variable-2 $aaaa][[','[number 2]',         ']][string mddatapribadipegawai"];',
     '[keyword echo] [string "aaa][variable-2 $aaaa][[','[number 2345]',      ']][string mddatapribadipegawai"];',
     '[keyword echo] [string "aaa][variable-2 $aaaa][[','[number 2.3]',       ']][string mddatapribadipegawai"];',
     '[keyword echo] [string "aaa][variable-2 $aaaa][[','[variable aaaaa]',   ']][string mddatapribadipegawai"];',
     '[keyword echo] [string "aaa][variable-2 $aaaa][[','[variable-2 $aaaaa]',']][string mddatapribadipegawai"];',
     '[meta ?>]');
  ...
  var m2 = build_recursive_monsters(
    ...
    '[comment /* }?>{{ */] [string "a?>}{{mddatapribadipegawai][variable-2 $aaa][string .a}a?>a"]',
    5
  );
